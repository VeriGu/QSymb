...
public class QASMLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "OPENQASM_KW", "INCLUDE_KW", "QREG_KW", "CREG_KW", "MEASURE_KW", 
			"TO", "RESET_KW", "BARRIER_KW", "PI_KW", "QUBIT", "ID", "REAL_LITERAL", 
			"INT_LITERAL", "STRING_LITERAL", "WORD", "DIGIT", "LETTER", "PLUS", "MINUS", 
			"MULT", "DIV", "WHITESPACE"
		};
	}
	...
	public QASMLexer(CharStream input) {
		super(input);
