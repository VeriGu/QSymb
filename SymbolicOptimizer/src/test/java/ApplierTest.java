...
public class ApplierTest {
    ...
    private Applier applier = new Applier(new Random(), 5);
//
//    @Test
...
//        String replaceAfter = "";
//        var circuitDag = applier.qasmToDag(circuit);
//        circuitDag = applier.applySymbRule(circuitDag, findBefore, findAfter, replaceBefore, replaceAfter, applier.parseConstraints(constraints));
//        System.out.println(applier.dagToQasm(circuitDag));
//        assertEquals("s q0; \ncx q1, q0; \ncx q0, q1; \n", applier.dagToQasm(circuitDag));
//    }
//
