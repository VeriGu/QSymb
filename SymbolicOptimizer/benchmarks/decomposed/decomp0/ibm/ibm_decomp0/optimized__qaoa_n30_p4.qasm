...
u2(0.0,pi) q[23]; 
u1(-pi/2.0) q[0]; 
u1(5.14159265358979) q[24]; 
u1(2.0) q[22]; 
u1(2.0) q[6]; 
u1(2.0) q[16]; 
u1(5.14159265358979) q[20]; 
...
u1(2.0) q[23]; 
u1(-pi/2.0) q[2]; 
u1(5.14159265358979) q[22]; 
u1(5.14159265358979) q[25]; 
u1(5.14159265358979) q[28]; 
